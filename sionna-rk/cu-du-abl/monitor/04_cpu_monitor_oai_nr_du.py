#!/usr/bin/env python3
"""04_cpu_monitor_oai_nr_du.py

Collect container-level CPU utilization for `oai-nr-du` using `docker stats`.

Example:
  python3 04_cpu_monitor_oai_nr_du.py --interval 0.5 --out du_cpu.csv
