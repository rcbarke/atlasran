...
Generated: 2026-02-19T00:39:55.768530+00:00
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | NA | NA | 208.90/211.02 | 1.92/2.20 | 208.65/222.09 | 0.571 | 1.32/2.30 | 11.83/12.23 |
| 1 | 101.20 | 101.20 | 346.57/348.92 | 20.51/21.84 | 322.55/360.40 | 1.287 | 45.43/50.00 | 37.54/39.10 |
| 3 | 64.82 | 21.61 | 326.69/347.02 | 16.63/18.17 | 319.22/344.05 | 0.827 | 28.33/33.90 | 28.91/30.40 |
| 6 | 32.78 | 5.46 | 224.35/235.22 | 9.22/11.08 | 342.61/386.26 | 0.445 | 15.70/20.00 | 20.89/22.04 |
| 12 | 16.76 | 1.40 | 175.38/182.50 | 5.98/7.16 | 337.65/377.38 | 0.245 | 8.71/13.30 | 16.58/17.55 |
...
- LDPC decode: n=34 mean_us=208.65 p95_us=222.09 max_us=222.49 events_per_s=0.571
...
- DU log errors: aborted=0, assert=0, buffer_overflow=0, error=0, failed=0, segfault=0, timeout=0
- LDPC decode: n=77 mean_us=322.55 p95_us=360.40 max_us=410.63 events_per_s=1.287
...
- DU log errors: aborted=0, assert=0, buffer_overflow=0, error=0, failed=0, segfault=0, timeout=0
- LDPC decode: n=49 mean_us=319.22 p95_us=344.05 max_us=368.99 events_per_s=0.827
...
- DU log errors: aborted=0, assert=0, buffer_overflow=0, error=0, failed=0, segfault=0, timeout=0
- LDPC decode: n=26 mean_us=342.61 p95_us=386.26 max_us=404.88 events_per_s=0.445
...
- DU log errors: aborted=0, assert=0, buffer_overflow=0, error=0, failed=0, segfault=0, timeout=0
- LDPC decode: n=14 mean_us=337.65 p95_us=377.38 max_us=380.77 events_per_s=0.245
